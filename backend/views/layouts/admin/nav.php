...
<div class="navbar main">
	...
	echo Menu::widget([
	    'items' => [
	        ['label' => 'Dashboard', 'url' => ['admin/dashboard'], 'template' => '<a class="glyphicons dashboard" href="{url}"><i></i>{label}</a>'],
	        ['label' => 'Profil', 'options'=>['class'=>'dropdown dd-1'], 'url' => ['admin'], 'template' => '<a data-toggle="dropdown" class="glyphicons building" href="{url}"><i></i>{label} <span class="caret"></span></a>',
				'items' => [
					['label' => 'Tim Pengembang', 'url' => ['admin/tim-pengembang']],
					['label' => 'Lokasi Studio', 'url' => ['admin/studio']],
					['label' => 'Deskripsi', 'url' => ['admin/deskripsi']],
				], 'submenuTemplate' => "\n<ul class='dropdown-menu pull-left'>\n{items}\n</ul>\n"
			],
			['label' => 'Projects', 'url' => ['admin/projects'], 'template' => '<a class="glyphicons gamepad" href="{url}"><i></i>{label}</a>'],
			['label' => 'Kredit User', 'options'=>['class'=>'dropdown dd-1'], 'url' => ['admin/kredit'], 'template' => '<a data-toggle="dropdown" class="glyphicons coins" href="{url}"><i></i>{label} <span class="caret"></span></a>',
				'items' => [
					['label' => 'Lihat Status', 'url' => ['admin/kredit']],
					['label' => 'Isi Kredit User', 'url' => ['admin/kredit/isi']],
				], 'submenuTemplate' => "\n<ul class='dropdown-menu pull-left'>\n{items}\n</ul>\n"
			],
			['label' => 'Item Toko', 'url' => ['admin/item-toko'], 'template' => '<a class="glyphicons sampler" href="{url}"><i></i>{label}</a>'],
			['label' => 'Kuesioner', 'url' => ['admin/kuesioner'], 'template' => '<a class="glyphicons notes" href="{url}"><i></i>{label}</a>'],
	    ],
		'options' => [
