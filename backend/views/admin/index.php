										...
										<div class="alert alert-gray">
											...
											<div class="gallery gallery-2">
												<ul class="row-fluid" data-toggle="modal-gallery" data-target="#modal-gallery" id="gallery-4" data-delegate="#gallery-4">
																										<li class="span2 hidden-phone"><a class="thumb" href="./theme/images/gallery-2/6.jpg" data-gallery="gallery"><img src="./theme/images/gallery-2/6.jpg" alt="photo" /></a></li>
																										<li class="span2 hidden-phone"><a class="thumb" href="./theme/images/gallery-2/5.jpg" data-gallery="gallery"><img src="./theme/images/gallery-2/5.jpg" alt="photo" /></a></li>
																										<li class="span2 hidden-phone"><a class="thumb" href="./theme/images/gallery-2/4.jpg" data-gallery="gallery"><img src="./theme/images/gallery-2/4.jpg" alt="photo" /></a></li>
																										<li class="span2"><a class="thumb" href="./theme/images/gallery-2/3.jpg" data-gallery="gallery"><img src="./theme/images/gallery-2/3.jpg" alt="photo" /></a></li>
																										<li class="span2"><a class="thumb" href="./theme/images/gallery-2/2.jpg" data-gallery="gallery"><img src="./theme/images/gallery-2/2.jpg" alt="photo" /></a></li>
																										<li class="span2"><a class="thumb" href="./theme/images/gallery-2/1.jpg" data-gallery="gallery"><img src="./theme/images/gallery-2/1.jpg" alt="photo" /></a></li>
																									</ul>
											</div>
											<!-- // Gallery Layout END -->
								...
								<div class="title">
									<div class="row-fluid">
										...
										<div class="span4 text-right">
											...
											<div class="margin-bottom-none progress progress-small progress-inverse count-outside"><div class="count">30%</div><div class="bar" style="width: 30%;"></div></div>
										</div>
									</div>
								</div>
								<hr/>
								<div class="body">
									<div class="row-fluid">
										<div class="span4 overflow-hidden">
											<!-- Profile Photo -->
											<div><a href="" class="thumb inline-block"><img data-src="holder.js/300x200" alt="Profile" /></a></div>
											<div class="separator bottom"></div>
											<!-- // Profile Photo END -->
										...
										<div class="span8">
											...
											<div class="row-fluid">
												...
												<div class="span7 offset1">
													...
													<div class="progress progress-mini progress-inverse count-outside add-outside"><div class="count">20%</div><div class="bar" style="width: 20%;"></div><div class="add">WP</div></div>
													<div class="separator bottom"></div>
												</div>
											</div>
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<div class="row-fluid">
									...
									<div class="span7">
										<img src="./theme/images/gallery-2/8.jpg" alt="" />
									</div>
								</div>
							</div>
							<!-- // Item END -->
							...
							<div class="item">
								<div class="row-fluid">
									...
									<div class="span7">
										<img src="./theme/images/gallery-2/9.jpg" alt="" />
									</div>
								</div>
							</div>
							<!-- // Item END -->
							...
							<div class="item">
								<div class="row-fluid">
									...
									<div class="span7">
										<img src="./theme/images/gallery-2/10.jpg" alt="" />
									</div>
								</div>
							</div>
							<!-- // Item END -->
